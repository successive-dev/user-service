...
var Server = /** @class */ (function () {
    ...
    Server.prototype.setupRoutes = function () {
        ...
        this.app.get('/api/secure', middlewares_1.authenticationRequired, function (req, res) {
            console.log('Secure api hit');
            res.send('Congrats u have hit a secure end point');
        });
        this.app.use('/api/user', controllers_1.userRouter);
    ...
    Server.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                try {
                    _a = this, app = _a.app, port_1 = _a.config.port;
                    app.listen(port_1, function () {
                        console.log("App is listening on port " + port_1 + "!");
                    });
                }
                catch (err) {
